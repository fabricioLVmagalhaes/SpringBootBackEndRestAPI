...
import com.fabriciomagalhaes.cursomc.domain.Endereco;
import com.fabriciomagalhaes.cursomc.domain.Estado;
import com.fabriciomagalhaes.cursomc.domain.ItemPedido;
import com.fabriciomagalhaes.cursomc.domain.Pagamento;
import com.fabriciomagalhaes.cursomc.domain.PagamentoComBoleto;
import com.fabriciomagalhaes.cursomc.domain.PagamentoComCartao;
...
import com.fabriciomagalhaes.cursomc.domain.enums.Perfil;
import com.fabriciomagalhaes.cursomc.domain.enums.TipoCliente;
import com.fabriciomagalhaes.cursomc.repositories.CategoriaRepository;
import com.fabriciomagalhaes.cursomc.repositories.CidadeRepository;
import com.fabriciomagalhaes.cursomc.repositories.ClienteRepository;
import com.fabriciomagalhaes.cursomc.repositories.EnderecoRepository;
import com.fabriciomagalhaes.cursomc.repositories.EstadoRepository;
...
import com.fabriciomagalhaes.cursomc.repositories.ProdutoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		produtoRepository.saveAll(Arrays.asList(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14,
				p15, p16, p17, p18, p19, p20, p21, p22, p23, p24, p25, p26, p27, p28, p29, p30, p31, p32, p34,
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "fabricio.lvm@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));		
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "megafabricio@hotmail.com", "02390621678", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.addPerfil(Perfil.ADMIN);
		cli2.getTelefones().addAll(Arrays.asList("52443323", "93838547"));
		...
		Pagamento pagto1 = new PagamentoComCartao(null, EstadoPagamento.QUTADO, ped1, 6);
